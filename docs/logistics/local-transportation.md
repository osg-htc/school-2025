...
Otherwise, you may use a ride-sharing service or taxi, or take the Madison Metro Bus.
...
You can pay with cash, or, if you prefer, you can download the Madison Metro Transit Fast Fares
mobile app, which allows you to add funds and scan a QR code to board the bus. This route does
